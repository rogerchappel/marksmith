...
Replace this section with the supported versions for `marksmith`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `marksmith` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in marksmith.
